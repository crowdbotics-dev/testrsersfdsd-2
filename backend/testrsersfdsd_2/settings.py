"""
Django settings for testrsersfdsd_2 project.
...
ROOT_URLCONF = 'testrsersfdsd_2.urls'
...
WSGI_APPLICATION = 'testrsersfdsd_2.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "testrsersfdsd Support <support@testrsersfdsd-2.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testrsersfdsd_2 API",
    "DESCRIPTION": "API documentation for testrsersfdsd_2 App",
    "VERSION": "v1",
}
